...
relative text-nowrap bg-[#02CDCF] border border-solid border-[#02CDCF] rounded-[12px] recharge text-[12px] sm:text-[18px]  text-[#000] font-bold p-[7px_9px_7px_9px] sm:p-[18px_32px_18px_32px]`}>
                {props.text}
            </button>
        </>
    )
