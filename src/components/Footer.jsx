...
const Footer = () => {
    return (
        <>
            <div className='bg-[url(../src/assets/img/footerBgimg.webp)] bg-cover bg-center bg-no-repeat px-3'>
                        ...
                        <div className=' max-[822px]:col-span-2 flex max-[822px]:justify-between max-[442px]:gap-[14px] max-[442px]:flex-col gap-[125px] justify-end max-[822px]:mt-0 mt-[145px] mb-[30px] '>
                            <div className='col-span-1 flex justify-end flex-col'>
                                <ul className='max-w-[125px]'>
                                    ...
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px]  text-[#B6B8B8] hover:text-[white] transition duration-300 '><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300'>Home</a></li>
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px]  text-[#B6B8B8] hover:text-[white] transition duration-300 '><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300' href="#_">Features</a></li>
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px]  text-[#B6B8B8] hover:text-[white] transition duration-300 '><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300' href="#_">Marketplace</a></li>
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px]  text-[#B6B8B8] hover:text-[white] transition duration-300 '><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300' href="#_">Tokens</a></li>
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px]  text-[#B6B8B8] hover:text-[white] transition duration-300 '><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300' href="#_">NexChat</a></li>
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px]  text-[#B6B8B8] hover:text-[white] transition duration-300 '><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300' href="#_">About</a></li>
                                </ul>
                            </div>
                            <div className='col-span-1 '>
                                <ul className='max-w-[145px] max-[442px]:mt-[20px]'>
                                    ...
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px]  text-[#B6B8B8] hover:text-[white] transition duration-300 '><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300' href="#_">Contact</a></li>
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px]  text-[#B6B8B8] hover:text-[white] transition duration-300 '><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300' href="#_">Phone</a></li>
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px]  text-[#B6B8B8] hover:text-[white] transition duration-300 '><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300' href="#_">terms</a></li>
                                    <li className='recharge text-[16px] pt-[20px] fony-bold leading-[19.2px] hover:text-[white] transition duration-300 text-[#B6B8B8]'><a className='relative after:absolute after:bg-white after:h-[2px] duration-500 after:hover:w-full after:bottom-[-4px] after:rounded-[23px] after:left-0 after:w-0 after:hover:duration-300 after:duration-300' href="#_">Privacy</a></li>
                                </ul>
                            </div>
                        </div>
